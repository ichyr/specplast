    ...
    function($scope, $http, uiGridGroupingConstants, i18nService) {
      ...
      $scope.gridOptions = {
        ...
        columnDefs: [
          ...
          { name: 'troop', displayName: 'Курінь', width: '100' },
          { name: 'group', displayName: 'Гурток', width: '100' },
          { name: 'city', displayName: 'Станиця', width: '100' },
          { name: 'region', displayName: 'Округа', width: '100' },
          { name: 'vmilist_id', displayName: 'Вмілість', width: '100' },
          { name: 'achievement_date', displayName: 'Дата здобуття', width: '100', enableGrouping: false },
          { name: 'place', displayName: 'Місце здобуття', width: '100' },
          { name: 'activity', displayName: 'Акція', width: '100' },
          {
            name: 'instruktor_id',
